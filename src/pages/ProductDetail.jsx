...
import { getProductId } from "../services/product.service";
import { ConvertPrice } from "../services/ConvertPrice.servies";
import { useDispatch } from "react-redux";
import { addToCart } from "../redux/slices/cartSlice";
import ProductDetailLoading from "../components/Fragments/ProductDetailLoading";
      ...
      {Object.keys(product).length > 0 ? (
        <section className="pt-36 pb-32">
          <div className="container mx-auto px-4 flex items-center justify-center">
            <div className="flex gap-x-10  max-w-[1000px] ">
